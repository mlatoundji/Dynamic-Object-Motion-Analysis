...
\begin{enumerate}
  ...
  \item \textbf{Branche track} : séquence track (pos, vel, acc) de dimension 9 par frame ; CNN 1D temporelle (Conv1D + BN + ReLU + Dropout) ou LSTM + pooling global $\to$ $\mathbf{h}_{\mathrm{track}}$.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccc}
    \toprule
    Configuration  & Track          & Optical flow   & Type de fusion \\
    \midrule
